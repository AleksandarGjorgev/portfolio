...
export default function Hero() {
  return (
<motion.section
  className="relative w-full h-[85vh] sm:h-[70vh] flex flex-col md:flex-row justify-center items-center bg-gradient-to-br from-card to-secondary text-center md:text-left overflow-hidden px-4 md:px-8 lg:px-16"
  initial={{ opacity: 0, y: -50 }}
  animate={{ opacity: 1, y: 0 }}
  transition={{ duration: 0.7, ease: "easeOut" }}
>
  {/* Profile Picture on the Right */}
  <div className="w-48 h-48 md:w-64 md:h-64 md:order-last md:mr-8 mb-6 md:mb-0">
    <Image
  ...
  <div className="flex flex-col items-center md:items-start">
    {/* Animated Heading */}
    <motion.h1
      className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-transparent pb-2 bg-clip-text bg-gradient-to-r from-accent to-red-300 mb-4"
    ...
    {/* Typing Animation */}
    <motion.div
      className="text-lg sm:text-xl md:text-2xl mb-6 max-w-lg md:max-w-2xl"
